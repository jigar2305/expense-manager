		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<f:form method="post" action="expense" modelAttribute="expense">
					...
					<div class="form-group">
						<label>Payment Method</label> <select name="payment" id="cars"
							class="form-control">
							<optgroup label="Cash">
			...
			<div class="col-md-4">
				<div class="form-popup" id="myForm">
					...
					<f:form method="post" action="addcategory"
						...
						<button type="submit" class="btn btn-primary" onclick="closeForm()">Add</button>
					</f:form>
				</div>
			<div class="form-popup" id="myForm1">
				...
				<f:form method="post" action="addsubcategory"
					...
					<button type="submit" class="btn btn-primary" onclick="closeForm1()">Add</button>
				</f:form>
			</div>
		</div>
	</div>
			...
			.ready(
				function () {
					...
					$("#category")
						.click(
							function () {
								let hidecategory = document
									.getElementById("hidecategory");
								hidecategory.setAttribute(
									"style",
									"display:visible");

								let categoryid = document
									.getElementById("category").value;
								let url = "http://localhost:8980/subcategory/"
									+ categoryid;
								$
									.get(url)
									.done(
